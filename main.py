...
######## Draw the selected robot ##########
		if visu.selected is not None: #and visu.selected['name'] == 'Y':
			pygame.draw.circle(WIN,BLACK, ((SQUARE_SIZE//2)+SQUARE_SIZE*visu.selected['col'],(SQUARE_SIZE//2)+SQUARE_SIZE*visu.selected['row']), radius-10)
			...
			for AvMove in Av_moves:
				#print(AvMove)
				pygame.draw.circle(WIN,BLACK, ((SQUARE_SIZE//2)+SQUARE_SIZE*Av_moves[AvMove][1],(SQUARE_SIZE//2)+SQUARE_SIZE*Av_moves[AvMove][0]), radius-10)
